    ...
    <div class="modal-dialog"> 
      ...
      <div class="modal-content">
        ...
        <form id="update-form">
             ...
             <br>
             <br>
             <img class="w-15" id="oldImg" src="{{ asset('images/Screenshot27.png') }}">
             <br>
    ...
    async function Update(){
      ...
      let productImgUpdate=document.getElementById('productImgUpdate').files[0];
        ...
        if(productCategoryUpdate.length===0){
            ...
            errorToast('Product Name Update Required !')
        }
        else if(productPriceUpdate.length===0){
            errorToast('Product price Update Required !')
        }
        else if(productUnitUpdate.length===0){
            errorToast('Product Unit Update Required !')
        }
