...
class InvoiceController extends Controller
{
    ...
    function invoiceCreate(Request $request)
    {
        ...
        try {
            ...
            DB::commit(); //when query is confirm then save
 ...
 */
    ...
    function invoiceDetails(Request $request)
    {
        ...
        $invoiceDetails = Invoice::where('user_id', $user_id)->where('id', $request->input('inv_id'))->first();

        $invoiceProduct = InvoiceProduct::where('invoice_id', $request->input('inv_id'))->where('user_id', $user_id)
            ->get();
